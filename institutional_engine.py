...
def evaluate_breakout(symbol):
    ...
    conditions = [
        last["close"] > prev5_high,                # Breakout
        last["volume"] > 2 * last["avg_vol"],     # Relative volume spike
        last["close"] > last["ema20"],            # Trend alignment
        last["close"] > last["vwap"],             # VWAP confirmation
        last["close"] > last["open"],             # Strong candle
    ]
